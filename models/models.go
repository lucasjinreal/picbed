...
func init() {
	...
	dbType = config.SiteConfig.DbOption.DbType
	dbName = config.SiteConfig.DbOption.DbName
	user = config.SiteConfig.DbOption.DbUser
	password = config.SiteConfig.DbOption.DbPass
	host = config.SiteConfig.DbOption.DbHost
	tablePrefix = config.SiteConfig.DbOption.TablePrefix
